...
def get_roi_IR_stats(im, roimask):
    ...
    ir_pcts = np.percentile(ir_vals, (5., 10., 25., 50., 75., 90., 95.))
...
class IRROITimeSeries(object):
    ...
    def format_csvrow(self, roits_row):
        ...
        ir_pcts = [roits_row['ir_5_qtl'], roits_row['ir_10_qtl'],
                   roits_row['ir_25_qtl'], roits_row['ir_50_qtl'],
        ...
        if roits_row['ir_mean'] == ND_FLOAT:
            ...
            csvfmt = '{:.5f},{:.5f}'
        csvstr_1 = csvfmt.format(roits_row['ir_mean'],
                                 roits_row['ir_std'])
    ...
    def writeCSV(self, file=""):
        ...
        hdstrings.append('#\n')
        hdstrings.append(
            '# ROI IR statistics timeseries for {0}\n'.format(self.site))
        hdstrings.append('#\n')
